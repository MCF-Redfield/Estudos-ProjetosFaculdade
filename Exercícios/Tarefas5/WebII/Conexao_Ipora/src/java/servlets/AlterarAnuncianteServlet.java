 ...
 */
@WebServlet(name = "AlterarAnuncianteServlet", urlPatterns = {"/AlterarAnuncianteServlet"})
public class AlterarAnuncianteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            daoAnunciante.alterar(anunciante);
        }
    }
