...
import dao.InterfaceAnuncianteDAO;
 ...
 */
@WebServlet(name = "RemoverAnuncianteServlet", urlPatterns = {"/RemoverAnuncianteServlet"})
public class RemoverAnuncianteServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            daoAnunciante.remover(anunciante);
        }
    }
