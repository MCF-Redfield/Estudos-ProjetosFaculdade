        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>");
             ...
             if(produtos != null){
                 ...
                 out.printf("<br> Quantidade de produtos escolhidos: " + qtdproduto);
                  out.printf("<br>Produto escolhidos: ");
                 for(int i =0 ; i<qtdproduto ; i++){
                     out.printf("<br> "+ produtos[i]);
                 }
             }
             else{
                 out.printf("Nenhum produto foi escolhido!");
             }
